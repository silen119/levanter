...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_255b764a4fab53438783469e76487da22a').trim(),
  DATABASE:
  ...
  SUDO: process.env.SUDO || '+94716022100',
  HEROKU_APP_NAME: process.env.HEROKU_APP_NAME,
  HEROKU_API_KEY: process.env.HEROKU_API_KEY,
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || '🥵𝚂𝚃𝙸𝙲𝙺𝙴𝚁 𝙱𝚈,𝙳𝙰𝚂𝚄𝙽',
